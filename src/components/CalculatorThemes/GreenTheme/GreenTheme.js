...
class GreenTheme extends Component {
	state = {
		displayValue: '0',
		operandClick: false,
		operator: null,
					...
					<div className="calculator">
						<div
							className={
								displayValue >= 9999999
									? 'calculator-display-green-small'
									: 'calculator-display-green'
							}
						>
						...
						<div className="calculator-keys">
							<div className="input-keys">
								<div className="function-keys-green">
									<button
										className="calculator-key functions-green"
								...
								<div className="number-keys-green">
									<button
										id="key-0"
										className="calculator-key digits-green"
							...
							<div className="operator-keys">
								<button
									className="calculator-key operators-green"
									onClick={() => this.doMath('/')}
								>
									÷
								</button>
